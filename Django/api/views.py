...
#    queryset = Article.objects.raw('SELECT * FROM api_article')
#    serializer_class = ArticleSerializer


class BoardView(viewsets.ModelViewSet):
    queryset = Board.objects.raw('SELECT * FROM api_board')
    serializer_class = BoardSerializer

        
class CommentView(viewsets.ModelViewSet):
    queryset = Comment.objects.raw('SELECT * FROM api_comment')
